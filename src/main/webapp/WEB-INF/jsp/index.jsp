...
<div id="demo" class="carousel slide" data-ride="carousel" style="width: 100%">
  ...
  <div class="carousel-inner" style="height: 600px">
      ...
      <img src="<c:url value="/images/nen5.webp"/>" alt="Linhkien" style="height: 600px; width: 100%">
    </div>
    <div class="carousel-item">
      <img src="<c:url value="/images/nen2.jpg"/>" alt="Linhkien">
    </div>
    <div class="carousel-item">
      <img src="<c:url value="/images/nen1.png"/>" alt="Linhkien">
    </div>
  </div>
...
<form action="">
    ...
    <div class="row">
        <c:forEach var="p" items="${Linhkien}"> 
         <div class="card col-md-4" >
             <div class="card" >
                <div class="card-body bg-light">
                    <a href="<c:url value="/Linhkien/${p.maLK}"/>">
                        <img  style="width: 290px; height: 300px" src="${p.hinhanh}" alt="${p.tenLK}"/>
                          <c:if test="${p.hinhanh == null || p.hinhanh.startsWith('https')== false}">
                              <img  src="<c:url value="/images/1.jpg"/>" alt="${p.tenLK}"/>
                          </c:if>
                    </a>
                      <h3>${p.tenLK}</h3>
                      <p>${p.gia} VND</p>
                ...
                <sec:authorize access="hasRole('ROLE_USER')">
                      <c:if test="${pageContext.request.userPrincipal.name != null}">
                          <div class="card-footer bg-dark">
                              <a href="javascript:;" class="btn btn-danger" onclick="addToCart(${p.maLK})">Thêm vào giỏ</a>
